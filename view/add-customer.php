        ...
        <div class="contrainer">
            <div class="form container px-4 px-lg-5 mt-5">
                <form action="<?= BASE_URL . "add-customer"?>" method="POST">
                    ...
                    <div class="form-group my-3">
                        <input type="text" id="address" name="address" class="sign form-control" placeholder="Naslov">
                    </div>
                    <div class="form-group my-3">
                        <input type="number" min="1000" max="9999" id="post_number" name="post_number" class="sign form-control" placeholder="Poštna številka">
                    </div>
                    <div class="form-group my-3">
                        <input type="text" id="post_city" name="post_city" class="sign form-control" placeholder="Kraj">
                    </div>
                    <div class="form-group my-3">
